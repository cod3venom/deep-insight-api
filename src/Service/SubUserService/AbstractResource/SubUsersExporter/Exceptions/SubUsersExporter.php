...
class SubUsersExporter
{
    ...
    public function export(string $authorUserId): array
    {
        ...
        $sheet->getCell('S1')->setValue('Head quarters');
        $sheet->getCell('T1')->setValue('Business phones');
        $sheet->getCell('U1')->setValue('Business e-mails');
        $sheet->getCell('V1')->setValue('Revenue');
        $sheet->getCell('W1')->setValue('Profit');
        $sheet->getCell('X1')->setValue('Growth year to year');
